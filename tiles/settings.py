"""
Django settings for tiles project.
...
WSGI_APPLICATION = 'tiles.wsgi.application'
...
EMAIL_HOST_USER = os.getenv('DJANGO_EMAIL_HOST_USER', 'your@email.com')
EMAIL_HOST_PASSWORD = os.getenv('DJANGO_EMAIL_HOST_PASSWORD', 'yourpassword')
